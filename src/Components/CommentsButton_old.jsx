...
export default function Comments({ onCommentsSubmit }) {
    ...
    const validateResponses = () => {
        ...
        if (!responses.additionalRequests && responses.additionalRequests !== 'Skip') {
    ...
    const handleSubmit = () => {
        ...
        axios.post(GENERATECOMMETS, data, {
            headers: {
            ...
            .then(response => {
                ...
                localStorage.setItem('response', JSON.stringify(response.data?.comments));
            ...
            {showPopup && (
                <div className="fixed z-[10] p-2 flex justify-end bottom-0 right-[0px] h-[85vh] max-w-[510px] w-[96%] overflow-hidden">
                    <div className="bg-white p-0 rounded-lg shadow-lg max-w-[500px] w-full relative h-[100%] overflow-auto">
                        <h2 className="text-lg font-semibold bg-[#c2e7ff] p-3 sticky top-0 z-[2]">Comment</h2>
                        <form className='label-size p-5 relative h-[calc(100%-52px)] flex justify-between flex-col'>
                            <div className='flex flex-col'>
                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 1: Do you prefer detailed comments or brief notes?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                type="radio"
                                                value="Detailed Comments"
                                                checked={responses.detailedComments === 'Detailed Comments'}
                                                name="briefOrDetailed"
                                                onChange={() => handleRadioChange('detailedComments', 'Detailed Comments')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="briefOrDetailed"
                                                onChange={() => handleRadioChange('detailedComments', 'Brief notes')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="briefOrDetailed"
                                                onChange={() => handleRadioChange('detailedComments', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {validationErrors.detailedComments && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.detailedComments}</p>
                                    )}
                                </div>

                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 2: Should the comments focus on strict legal accuracy or practical implications?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                type="radio"
                                                ...
                                                onChange={() => handleRadioChange('legalAccuracy', 'Legal Accuracy')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                checked={responses.legalAccuracy === 'Practical implications'}
                                                name="accuracyOrPractical"
                                                onChange={() => handleRadioChange('legalAccuracy', 'Practical implications')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="accuracyOrPractical"
                                                onChange={() => handleRadioChange('legalAccuracy', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {validationErrors.legalAccuracy && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.legalAccuracy}</p>
                                    )}
                                </div>

                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 3: Are there any specific sections you want more detailed feedback on?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <textarea
                                            id="specificSections"
                                            ...
                                            onChange={(e) => handleTextAreaChange('sectionsFeedback', e.target.value)}
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="sectionsFeedback"
                                                onChange={() => handleRadioChange('sectionsFeedback', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {validationErrors.sectionsFeedback && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.sectionsFeedback}</p>
                                    )}
                                </div>

                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 4: Do you have any style preferences for the comments (e.g., formal, casual)?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                type="radio"
                                                ...
                                                onChange={() => handleRadioChange('stylePreferences', 'Formal')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="stylePreference"
                                                onChange={() => handleRadioChange('stylePreferences', 'Casual')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="stylePreference"
                                                onChange={() => handleRadioChange('stylePreferences', 'Other')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="stylePreference"
                                                onChange={() => handleRadioChange('stylePreferences', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {showOtherTextarea && (
                                        <textarea
                                            ...
                                            onChange={(e) => handleTextAreaChange('otherComments', e.target.value)}
                                        />
                                    )}
                                    {validationErrors.stylePreferences && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.stylePreferences}</p>
                                    )}
                                </div>

                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 5: Do you want comments on formatting and structure as well as content?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                type="radio"
                                                value="Formatting and Structure"
                                                checked={responses.formatStructure === 'Formatting and Structure'}
                                                name="formattingStructure"
                                                onChange={() => handleRadioChange('formatStructure', 'Formatting and Structure')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="formattingStructure"
                                                onChange={() => handleRadioChange('formatStructure', 'Content only')}
                                            />
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="formattingStructure"
                                                onChange={() => handleRadioChange('formatStructure', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {validationErrors.formatStructure && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.formatStructure}</p>
                                    )}
                                </div>

                                <div className="mb-6">
                                    <label className="block text-[15px] font-semibold mb-2">Q 6: Do you have any additional requests?</label>
                                    <div className="flex gap-4 flex-wrap">
                                        <textarea
                                            ...
                                            onChange={(e) => handleTextAreaChange('additionalRequests', e.target.value)}
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <input
                                                ...
                                                name="additionalRequests"
                                                onChange={() => handleRadioChange('additionalRequests', 'Skip')}
                                            />
                                            <span className="ml-2">Skip</span>
                                        </label>
                                    </div>
                                    {validationErrors.additionalRequests && (
                                        <p className="text-red-500 text-[12px] mt-1">{validationErrors.additionalRequests}</p>
                                    )}
                                </div>
                            </div>
